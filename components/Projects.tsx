...
const DashboardDemo = () => {
  ...
  return (
    <div className="w-full h-full bg-[#f8fafc] flex overflow-hidden font-dashboard select-none relative group/dashboard">
      ...
      {/* Sidebar */}
      <div className="w-20 border-r border-slate-200 bg-white flex flex-col items-center py-6 gap-6 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)] transition-all duration-300">
        ...
        <div className="flex-1 flex flex-col bg-white">
           ...
           <div className="h-14 border-b border-slate-200 flex items-center justify-between px-6 bg-white shadow-sm z-20">
              <div className="flex items-center gap-3">
                 <h3 className="font-bold text-slate-800 text-xl">{activeCoin}/KRW</h3>
   ...
   return (
      <div className="w-full h-full flex flex-col bg-[#f8fafc] relative font-luxury overflow-hidden">
         ...
         <div className="flex-1 flex items-center justify-center p-6">
            <div className="w-full max-w-[800px] h-[400px] bg-white rounded-3xl shadow-xl shadow-slate-200/60 overflow-hidden border border-slate-100 flex">
               
               {/* Left: Image Area */}
               <div className="w-1/2 bg-slate-50 relative flex items-center justify-center overflow-hidden group">
                  <motion.div
                     key={activeImage}
                  ...
                  >
                     <ShoppingBag size={180} className="text-slate-800 drop-shadow-2xl" strokeWidth={0.8} />
                  </motion.div>
...
const BrowserWindow: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="relative rounded-xl overflow-hidden bg-white border border-slate-200 shadow-2xl shadow-slate-200/50 transition-all duration-500 h-[500px] lg:h-[600px] w-full transform group-hover:scale-[1.01]">
              ...
              >
                 ...
                 <div className="lg:col-span-8">
                   <div className="relative">
                      ...
                      <div className={`absolute -top-10 -left-10 w-40 h-40 bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-full blur-3xl -z-10`} />
                      <div className={`absolute -bottom-10 -right-10 w-60 h-60 bg-gradient-to-tl from-blue-500/20 to-emerald-500/20 rounded-full blur-3xl -z-10`} />
