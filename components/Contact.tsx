        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div>
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="font-display text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-none mb-8"
            >
              YOUR VISION,<br/>
          ...
          <div className="flex flex-col justify-center gap-8 lg:pl-20">
             ...
             <div className="space-y-6">
               <a 
                ...
                className="group flex items-center justify-between p-8 rounded-3xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all cursor-pointer"
               >
                 <div>
               ...
               <button 
                ...
                className="w-full group flex items-center justify-between p-8 rounded-3xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all cursor-pointer text-left"
               >
                 <div>
